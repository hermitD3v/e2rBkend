...
cd HDMTOS
git sparse-checkout set I2L TAL HAL Validation/iVal
#/HBI Validation/iVal/HDMT Validation/iVal/ValidationCode/TestClasses Validation/iVal/ValidationCode/UserFunctions Validation/iVal/BuildScripts
